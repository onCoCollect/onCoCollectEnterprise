...
var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('./modules/handle-onco-dom');
...
sweetAlert = onco = function () {
  ...
  switch (typeof customizations) {
    ...
    // Ex: onco("Hello", "Just testing", "info");
    case 'string':
    ...
    // Ex: onco({ title:"Hello", text: "Just testing", type: "info" });
    case 'object':
 ...
 */
sweetAlert.setDefaults = onco.setDefaults = function (userParams) {
  if (!userParams) {
 ...
 */
sweetAlert.close = onco.close = function () {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.showInputError = onco.showInputError = function (errorMessage) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.resetInputError = onco.resetInputError = function (event) {
...
if (typeof define === 'function' && define.amd) {
  ...
  window.sweetAlert = window.onco = sweetAlert;
} else if (typeof module !== 'undefined' && module.exports) {
  module.exports = sweetAlert;
}

},{"./modules/default-params":2,"./modules/handle-click":3,"./modules/handle-dom":4,"./modules/handle-key":5,"./modules/handle-onco-dom":6,"./modules/set-params":8,"./modules/utils":9}],2:[function(require,module,exports){
'use strict';
...
var _getModal = require('./handle-onco-dom');
...
},{"./handle-dom":4,"./handle-onco-dom":6,"./utils":9}],4:[function(require,module,exports){
'use strict';
...
var _setFocusStyle = require('./handle-onco-dom');
...
},{"./handle-dom":4,"./handle-onco-dom":6}],6:[function(require,module,exports){
'use strict';
...
var _getModal$getInput$setFocusStyle = require('./handle-onco-dom');
    ...
    var _ret = (function () {
      ...
      switch (params.type) {
        ...
        case 'prompt':
          ...
          setTimeout(function () {
            $input.focus();
            $input.addEventListener('keyup', onco.resetInputError);
          }, 400);
          break;
      }
    })();
...
},{"./handle-dom":4,"./handle-onco-dom":6,"./utils":9}],9:[function(require,module,exports){
'use strict';
